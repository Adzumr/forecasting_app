        ...
        child: BackgroundWidget(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.h),
              HourlyReportWidget(
                  smallForecastModel: widget.smallForecastModel),
              SizedBox(height: 4.h),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
...
class HourlyReportWidget extends StatelessWidget {
  const HourlyReportWidget({
    Key? key,
    required this.smallForecastModel,
  }) : super(key: key);
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          final smallWeather = smallForecastModel!.data![index];
